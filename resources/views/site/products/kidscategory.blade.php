...
@section('title',$title.' | '.__('site.kidscategories-title'))
        ...
        <div class="products-page">
            <div class="products">
                <div class="product-listy">
                    <h2>{{ __('site.kidscategories-categories') }}</h2>
                ...
                <div class="product-listy">
                    <h2>{{ __('site.kidscategories-brands') }}</h2>
                    <ul class="product-list">
                        ...
                        @foreach($main as $item)
                            <li>
                                <a class="cbp-vm-image" href="{{ asset('storage').'/'.$item->images }}">
                                        ...
                                        <div class="view view-first">
                                            <div class="inner_content clearfix">
                                                <div class="product_image">
                                                    ...
                                                    <div class="mask">
                                                        <div class="info">{{ __('site.kidscategories-quick-view') }}</div>
                                                    </div>
                                    ...
                                    <a class="cbp-vm-icon cbp-vm-add item_add" href="#">{{ __('site.kidscategories-add-to-cart') }}</a>
                                </div>
                            </li>
                        @endforeach
                    </ul>
