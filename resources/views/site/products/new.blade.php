...
@section('title',__('site.new-title'))
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">{{ __('site.new-title') }}</span>&nbsp;</li>
					</ul>
							...
							<li>
								...
								<div class="simpleCart_shelfItem"><a class="cbp-vm-image" href="{{ route('site.products',$item->url) }}">
									...
									<form action="{{ route('cart.store', $item) }}" method="post">
										@csrf
										<input type="submit" class="cbp-vm-icon cbp-vm-add item_add border-none" value="{{ __('site.new-add-to-cart') }}">
									</form>
								</div>
							</li>
						@endforeach
