...
@section('title',$title.' | '.__('site.accessoriesbrands-title'))
		...
		<div class="products-page">
			<div class="products">
				<div class="product-listy">
					<h2>{{ __('site.accessoriesbrands-categories') }}</h2>
				...
				<div class="product-listy">
					<h2>{{ __('site.accessoriesbrands-brands') }}</h2>
					<ul class="product-list">
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><a href="{{ route('site.accessories') }}">{{ __('site.accessories-title') }}</a>&nbsp;<span>&gt;</span></li>
					...
					<ul>
						@foreach($main as $item)
							<li>
								...
								@endif
								<div class="simpleCart_shelfItem"><a class="cbp-vm-image" href="{{ route('site.accessories-view',$item->url) }}">
										<div class="view view-first">
											<div class="inner_content clearfix">
												<div class="product_image">
													...
													@endif
													<div class="mask">
														<div class="info">{{ __('site.accessoriesbrands-quick-view') }}</div>
													</div>
									...
									<form action="{{ route('cart.store', $item) }}" method="post">
										@csrf
										<input type="submit" class="cbp-vm-icon cbp-vm-add item_add border-none" value="{{ __('site.accessoriesbrands-add-to-cart') }}">
									</form>
								</div>
							</li>
						@endforeach
