		...
		<div class="products-page">
			<div class="products">
				<div class="product-listy">
					<h2>{{ __('site.category-categories') }}</h2>
			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">{{ __('site.category-title') }}</span>&gt;</li>
							...
							<li>
								...
								<div class="simpleCart_shelfItem"><a class="cbp-vm-image" href="{{ route('site.products',$item->url) }}">
										<div class="view view-first">
											<div class="inner_content clearfix">
												<div class="product_image">
													...
													@endif
													<div class="mask">
														<div class="info">{{ __('site.category-quick-view') }}</div>
													</div>
									...
									<form action="{{ route('cart.store', $item) }}" method="post">
										@csrf
										<input type="submit" class="cbp-vm-icon cbp-vm-add item_add border-none" value="{{ __('site.category-add-to-cart') }}">
									</form>
								</div>
							</li>
						@endforeach
