...
@section('title',$title.' | '.__('site.menbrands-title'))
		...
		<div class="products-page">
			<div class="products">
				<div class="product-listy">
					<h2>{{ __('site.menbrands-categories') }}</h2>
				...
				<div class="product-listy">
					<h2>{{ __('site.menbrands-brands') }}</h2>
					<ul class="product-list">
							...
							<li>
								...
								<div class="simpleCart_shelfItem"><a class="cbp-vm-image" href="{{ route('site.men-view',$item->url) }}">
										<div class="view view-first">
											<div class="inner_content clearfix">
												<div class="product_image">
													...
													@endif
													<div class="mask">
														<div class="info">{{ __('site.menbrands-quick-view') }}</div>
													</div>
									...
									<form action="{{ route('cart.store', $item) }}" method="post">
										@csrf
										<input type="submit" class="cbp-vm-icon cbp-vm-add item_add border-none" value="{{ __('site.menbrands-add-to-cart') }}">
									</form>
								</div>
							</li>
						@endforeach
