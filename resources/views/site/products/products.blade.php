			...
			<div class="new-product">
				...
				<div class="col-md-7 dress-info">
					...
					<div class="span span1">
						<p class="left">{{ __('site.products-sale') }}</p>
						<p class="right">{{ $main->sale }}%</p>
						<div class="clearfix"></div>
					</div>

					<div class="span span2">
						<p class="left">{{ __('site.products-brand') }}</p>
						<p class="right">{{ $main->brand->name }}</p>
						<div class="clearfix"></div>
					</div>

					<div class="span span3">
						<p class="left">{{ __('site.products-madein') }}</p>
						<p class="right">{{ $main->made->name }}</p>
						<div class="clearfix"></div>
					</div>

					<div class="span span4">
						<p class="left">{{ __('site.products-color') }}</p>
						...
						@auth
							<form action="{{ route('site.wishlist',$main->id) }}" method="post">
								...
								<input class="simpleCart_shelfItem cbp-vm-icon cbp-vm-add item_add btn-form"
									   type="submit"
									   value="{{ __('site.products-add-to-wishlist') }}">
							</form>
						@endif
						<div class="clearfix"></div>
				...
				<div class="reviews-tabs">
					<ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
						<li class="test-class active text-content">{{ __('site.products-moreinformation') }}</li>
					</ul>
				...
				<div class="reviews-tabs">
					<ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
						<li class="test-class active text-content">{{ __('site.products-specifications') }}</li>
					</ul>
					<div class="tab-content responsive hidden-xs hidden-sm">
						<div class="tab-pane active">
				...
				<div class="reviews-tabs">
					<ul class="nav nav-tabs responsive hidden-xs hidden-sm" id="myTab">
						<li class="test-class active text-content">{{ __('site.products-reviews') }}</li>
					</ul>
					<div class="tab-content responsive hidden-xs hidden-sm">
						<div class="tab-pane active">
							<div class="response">
