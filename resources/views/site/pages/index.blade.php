            ...
            <div class="products-grid">
                @if(count($men)>0)
                    ...
                    @foreach($men as $item)
                        <div class="col-md-4 product simpleCart_shelfItem text-center">
                            <a href="{{ route('site.men-view', $item->url) }}"><img
                                        src="{{ asset('storage').'/'.$item->images }}"/></a>
                            <div class="mask">
                ...
                @if(count($women)>0)
                    ...
                    @foreach($women as $item)
                        <div class="col-md-4 product simpleCart_shelfItem text-center">
                            <a href="{{ route('site.women-view', $item->url) }}"><img
                                        src="{{ asset('storage').'/'.$item->images }}"/></a>
                            <div class="mask">
                ...
                @if(count($kids)>0)
                    ...
                    @foreach($kids as $item)
                        <div class="col-md-4 product simpleCart_shelfItem text-center">
                            <a href="{{ route('site.kids-view', $item->url) }}"><img
                                        src="{{ asset('storage').'/'.$item->images }}"/></a>
                            <div class="mask">
                ...
                @if(count($accessories)>0)
                    ...
                    @foreach($accessories as $item)
                        <div class="col-md-4 product simpleCart_shelfItem text-center">
                            <a href="{{ route('site.accessories-view', $item->url) }}"><img
                                        src="{{ asset('storage').'/'.$item->images }}"/></a>
                            <div class="mask">
