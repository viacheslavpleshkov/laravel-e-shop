    ...
    <div class="container">
        <div class="main-content">
            ...
            <div class="products-grid">
                ...
                @foreach($men as $iteam)
                    <div class="col-md-4 product simpleCart_shelfItem text-center">
                        <a href="{{ route('site.men-view',$iteam->url) }}"><img src="images/p3.jpg" alt=""/></a>
                        <div class="mask">
                            <a href="{{ route('site.men-view',$iteam->url) }}">Quick View</a>
                        </div>
                        <a class="product_name" href="{{ route('site.men-view',$iteam->url) }}">{{ $iteam->name }}</a>
                        <p><a class="item_add" href="#"><i></i> <span
                                        class="item_price">$ {{ $iteam->price }}</span></a></p>
                    </div>
                @endforeach
                <header>
